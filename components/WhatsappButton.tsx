...
export default function WhatsappButton() {
  ...
  return (
    ...
    >
      ...
      {/* CTA text - se expande en hover en pantallas md+ */}
      <span className="hidden md:block md:ml-0 max-w-0 overflow-hidden opacity-0 transition-all duration-300 ease-out group-hover:max-w-[220px] group-hover:opacity-100 whitespace-nowrap text-sm font-medium leading-none md:group-hover:mr-3">
