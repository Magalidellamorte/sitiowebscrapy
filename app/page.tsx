        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/reciclaje-urbano" className="text-white hover:text-green-400 transition-colors font-medium">
                reciclaje urbano
              </a>
              <a href="/reciclaje-industrial" className="text-white hover:text-green-400 transition-colors font-medium">
                reciclaje industrial
              </a>
              <a href="/barrios-cerrados" className="text-white hover:text-green-400 transition-colors font-medium">
                barrios cerrados
              </a>
              <a
                href="/contacto"
                className="bg-green-400 hover:bg-green-500 text-white px-6 py-3 rounded-full transition-all duration-300 hover:-translate-y-1 font-medium"
              >
                contacto
              </a>
            </div>
            ...
            <div className="md:hidden">
              <button onClick={toggleMenu} className="text-white hover:text-green-400 focus:outline-none">
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-black/80 backdrop-blur-md border-t border-white/20">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="/reciclaje-urbano" className="block px-3 py-2 text-white hover:text-green-400">
                  reciclaje urbano
                </a>
                <a href="/reciclaje-industrial" className="block px-3 py-2 text-white hover:text-green-400">
                  reciclaje industrial
                </a>
                <a href="/barrios-cerrados" className="block px-3 py-2 text-white hover:text-green-400">
                  barrios cerrados
                </a>
                <a href="/contacto" className="block px-3 py-2 text-green-400 font-medium">
                  contacto
                </a>
              </div>
            </div>
